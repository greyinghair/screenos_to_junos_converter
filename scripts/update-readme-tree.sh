...

{
  ...
  if [ -d packages ]; then
    ...
    [ -f packages/mapping_workspace.py ] && echo '|   |-- mapping_workspace.py            # Web interface-mapping workspace state'
  ...
  if [ -d tests ]; then
    ...
    [ -f tests/test_mapping_workspace.py ] && echo '|   |-- test_mapping_workspace.py        # Mapping workspace rows, form parsing, and flow'
    [ -f tests/test_web_app.py ] && echo '|   |-- test_web_app.py                 # Flask request and security tests'
    [ -f tests/test_web_assets.py ] && echo '|   |-- test_web_assets.py              # Client asset budget and accessibility contracts'
