...
def test_main_converts_and_reports_diagnostics(
    ...
    assert "number of lines converted: 25" in caplog.text
    assert "number of lines NOT converted: 2" in caplog.text
    assert "line 20 not converted: unsupported or unrecognized syntax" in caplog.text
